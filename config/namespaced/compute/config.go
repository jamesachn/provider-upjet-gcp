...
const (
	...
	SelfPackagePath = "github.com/upbound/provider-gcp/v3/config/namespaced/compute"
)
...
func Configure(p *config.Provider) { // nolint: gocyclo
	...
	p.AddResourceConfigurator("google_compute_instance_group_named_port", func(r *config.Resource) {
		...
		// 	Type:      "github.com/upbound/provider-gcp/v3/apis/namespaced/container/v1beta1.Cluster",
